...
#    tempRuns = sqlalchemy.Table('RPCPVSSTEMPPERRUN', metadata,
    tempRuns = sqlalchemy.Table('RPCPVSSTEMPPERRUN', metadata,
                                   ...
                                   sqlalchemy.Column('TEMP', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('TEMPRPCON', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('TEMPCMSON', sqlalchemy.Numeric(precision=10,length=8)),
...
#    generalRuns = sqlalchemy.Table('RPCPVSSPERRUN', metadata,
    generalRuns = sqlalchemy.Table('TESTOUT_PVSS', metadata,
                                   sqlalchemy.Column('RUN_NUMBER', sqlalchemy.Integer, primary_key = True, nullable=False ),
                                   sqlalchemy.Column('PVSSID', sqlalchemy.Integer, primary_key = True, nullable=False ),
                                   sqlalchemy.Column('IMON', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('IMONRPCON', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('IMONCMSON', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('IMONGOODSTATUS', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('IMONGOODAVERAGE', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('IMONSTATUS', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.Column('VMON', sqlalchemy.Numeric(precision=13,length=8)),
                                   sqlalchemy.Column('VMONRPCON', sqlalchemy.Numeric(precision=14,length=8)),
                                   sqlalchemy.Column('VMONCMSON', sqlalchemy.Numeric(precision=14,length=8)),
                                   sqlalchemy.Column('VMONGOODSTATUS', sqlalchemy.Numeric(precision=14,length=8)),
                                   sqlalchemy.Column('VMONGOODAVERAGE', sqlalchemy.Numeric(precision=14,length=8)),
                                   sqlalchemy.Column('VMONSTATUS', sqlalchemy.Numeric(precision=10,length=8)),
                                   sqlalchemy.PrimaryKeyConstraint('RUN_NUMBER','PVSSID',name="RPCPVSSPERRUN_PK"),
                                   #    sqlalchemy.PrimaryKeyConstraint('PVSSID',name="PVSSID_PK"),
                                   schema = self.__schema                               
                                )
