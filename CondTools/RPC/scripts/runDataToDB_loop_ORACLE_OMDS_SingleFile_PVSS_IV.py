...
runlistPVSSPERLUMI = []
runlistPVSSPERLUMI.append(199973)
...
#    continue
    ...
    dataPVSSPERRUN = fileReaderPVSSPERRUN.read(directory+str(run)+"_ImonPerRun.txt")
    dataPVSSPERRUNVMON = fileReaderPVSSPERRUN.read(directory+str(run)+"_VmonPerRun.txt")
